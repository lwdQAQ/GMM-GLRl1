function [K,w_jk,mu_jk,sigma_jk] = Estimate_num_comp(Y, A, ...
    sizes, shrink_size, max_num_comp)
thresh = 0.99;
ignore_small_prior = 0;%0.1
...
function num = CVIC(X, max_num_comp)
[N,B] = size(X);
